...
for i in range(0,len(organized_dhmoi)):
    Dhmos.objects.get_or_create(name = organized_dhmoi['ΚΑΛΛΙΚΡΑΤΙΚΟΙ ΔΗΜΟΙ'][i], category_name = organized_dhmoi['ΧΑΡΑΚΤΗΡΙΣΜΟΣ ΔΗΜΟΥ'][i], category = organized_dhmoi['category'][i])
